...
################################################################
# This is a generated script based on design: qsfp1
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set qsfp1_intl [ create_bd_port -dir I qsfp1_intl ]
  set qsfp1_modprsl [ create_bd_port -dir I qsfp1_modprsl ]
  set qsfp1_modsell [ create_bd_port -dir O -from 0 -to 0 qsfp1_modsell ]
  set qsfp1_resetl [ create_bd_port -dir O -from 0 -to 0 qsfp1_resetl ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M01_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins system_ila_2/SLOT_0_AXI]
  ...
  connect_bd_net -net qsfp1_intl_1 [get_bd_ports qsfp1_intl] [get_bd_pins vio_2/probe_in0]
  connect_bd_net -net qsp1_modprsl_1 [get_bd_ports qsfp1_modprsl] [get_bd_pins vio_2/probe_in1]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_ports qsfp1_modsell] [get_bd_ports qsfp1_resetl] [get_bd_pins xlconstant_2/dout]
